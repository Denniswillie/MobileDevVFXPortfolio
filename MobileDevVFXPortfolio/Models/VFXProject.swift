...
struct VFXProject: Identifiable {
    ...
    init(id: Int, title: String, descriptionHeading: String, description: String, videoUrl: URL, imageName: String, liked: Bool) {
        self.id = id
        self.title = title
