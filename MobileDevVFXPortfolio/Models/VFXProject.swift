...
extension VFXProject {
    static let projects: [VFXProject] = [
        ...
        VFXProject(id: 4, title: "Shang Chi Movie", descriptionHeading: "VFX work documentary.", description: "Discover the behind-the-scenes magic of the critically acclaimed movie 'Shang-Chi' with this captivating documentary. Follow the journey of a skilled VFX artist as they create their own homage to the film, pushing the boundaries of technology and artistic expression to bring their vision to life", videoUrl: Bundle.main.url(forResource: "video4", withExtension: "mp4")!, imageName: "thumbnail_4", liked: false, locked: true)
    ]
}
